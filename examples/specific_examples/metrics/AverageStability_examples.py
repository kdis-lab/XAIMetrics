# examples/specific_examples/metrics/AverageStability_examples.py
from pathlib import Path
import numpy as np

from xai_metrics.config import ConfigController
from xai_metrics.metrics.robustness import AverageStability
...
print("\nDirect class usage")
print("------------------")
print("AverageStability scores:", scores)
print("Mean AverageStability:", float(np.mean(scores)))

# run_evaluation use
results = run_evaluation(
    selected_metrics=["AverageStability"],
    config=config_path,
