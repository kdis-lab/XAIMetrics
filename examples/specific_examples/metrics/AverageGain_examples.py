# examples/specific_examples/metrics/AverageGain_examples.py
from pathlib import Path

import numpy as np

from xai_metrics.config import ConfigController
from xai_metrics.metrics.fidelity.completeness import AverageGain
...
print("\nDirect class usage")
print("------------------")
print("AverageGain scores:", scores)
print("Mean AverageGain:", float(np.mean(scores)))

# run_evaluation use
results = run_evaluation(
    selected_metrics=["AverageGain"],
    config=config_path,
