# examples/specific_examples/metrics/AverageIncrease_examples.py
from pathlib import Path

import numpy as np

from xai_metrics.config import ConfigController
from xai_metrics.metrics.fidelity.completeness import AverageIncrease
...
print("\nDirect class usage")
print("------------------")
print("AverageIncrease scores:", scores)
print("Mean AverageIncrease:", float(np.mean(scores)))

# run_evaluation use
results = run_evaluation(
    selected_metrics=["AverageIncrease"],
    config=config_path,
