# examples/specific_examples/metrics/RandomLogit_examples.py
from pathlib import Path
import numpy as np

from xai_metrics.config import ConfigController
from xai_metrics.metrics.sensitivity import RandomLogit
...
print("\nDirect class usage")
print("------------------")
print("RandomLogit scores:", scores)
print("Mean RandomLogit:", float(np.mean(scores)))

# run_evaluation use
results = run_evaluation(
    selected_metrics=["RandomLogit"],
    config=config_path,
